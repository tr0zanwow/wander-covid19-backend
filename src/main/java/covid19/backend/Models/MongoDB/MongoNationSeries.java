...
@Document(collection = "data_nation_series")
public class MongoNationSeries {
    ...
    public MongoNationSeries() {
    }

    public MongoNationSeries(String date, Integer dailyConfirmed, Integer totalConfirmed, Integer dailyRecovered, Integer totalRecovered, Integer dailyDeceased, Integer totalDeceased) {
        this.date = date;
